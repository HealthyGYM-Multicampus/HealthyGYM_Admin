		...
		<div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1" style="margin: auto; background-color: white; border-radius: 2em;">
			<form action="regiAf.do" method="post" id="regiForm">
				...
				<div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
							<p style="margin: auto; font-size:larger "><b>관리자 페이지 계정 생성</b></p>
				</div>
				<br>
				
				<div class="form-group input-group">
					<input id="email" name="email" class="form-control" placeholder="이메일 입력" type="text">
				...
				<div class="form-group input-group">
					<input id="name" name="name" class="form-control" placeholder="닉네임" type="text">
				</div>
